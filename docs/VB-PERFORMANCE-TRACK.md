...
- **CLOSED (R9a…R9d):** `vb_geo.comp.hlsl` (+ its `-D MOTION` sibling) and
  ...
  present). Golden: `[vb_mesh_ssao]` (`goldens/PINS.toml:723`, `85625a11…`).
