...
domain that could not see the thing it bounded (G23 / M10), and a licensing clause that required a
...
> says "28 showable-RED gates". The table below has **32 rows** (33 with `GJ1`), and neither the
...
- **rev 3's G14 recorder-symbol census** — self-contradictory, no RED constructible (B5). Replaced
  above.
