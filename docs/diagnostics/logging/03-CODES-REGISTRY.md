...
| `20xx`–`27xx` | RHI, RHI-Vulkan, render, shaderdsl, UI, fontbake, image, GPU columns | `E2101` (L7a) · `W2102`, `E2103`, `W2104`, `W2105`, `W2106` (L7b) — all six `boyko_rhi_vulkan`'s; `2106` is **not** in the ledger and was minted at L7b when the seven-site `E2103` split in two · `W2201`, `W2202`, `E2203`, `W2204`, `W2205`, `W2206` (render, L8a) — of which `W2204`, `W2205` and `W2206` are **not** in the ledger: `2204` was minted when `W2201`'s two sites split, `2205` and `2206` because the ledger named their sites without naming codes · `W2601`, `W2602` (image, L8a) |
