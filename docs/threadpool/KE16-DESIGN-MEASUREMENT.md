...
8. **`MIRIFLAGS` is replaced, not merged.** `.cargo/config.toml:62-63` sets `MIRIFLAGS =
...
# (`-Zmiri-tree-borrows`, .cargo/config.toml:62-63); the header of tests/miri_scope.rs (:61-69)
