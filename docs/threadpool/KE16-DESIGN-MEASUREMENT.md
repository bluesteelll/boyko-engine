...
8. **`MIRIFLAGS` is replaced, not merged.** `.cargo/config.toml:36-37` sets `MIRIFLAGS =
...
# (`-Zmiri-tree-borrows`, .cargo/config.toml:36-37); the header of tests/miri_scope.rs (:61-69)
