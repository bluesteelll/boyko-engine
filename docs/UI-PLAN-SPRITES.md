...
Plus **three dead PATHS**: `crates/boyko_ui/benches/ui_animation.rs` (`UI-PLAN-ANIMATION.md:2857`,
...
rung here"*; its ladder U0–U8 lands no registration table. `UI-PLAN-ANIMATION.md:3105` names
