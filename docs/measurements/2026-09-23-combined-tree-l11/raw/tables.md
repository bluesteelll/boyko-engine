timed processes 145 (re-runs 25), warm-ups 6, voided pass attempts 3 (45 processes discarded), invalid 0, contaminated before 0 / after 28 / build-proc-during 0, dropped slots 3
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| HL-D-tree | 1 | tip | 5 | 7.1062 | 6.8913 | 7.2863 | 0.3950 | 0.0848 | 5.56 % | 1.19 % | 0x32d5e235342b4143 | 1/1/0; others sum 0 | 1.76/2.43 | 129.9 |
...
| HL-D-allpairs | 2 | tip | 5 | 6.4349 | 6.2443 | 6.5570 | 0.3127 | 0.0818 | 4.86 % | 1.27 % | 0x32d5e235342b4143 | 0/0/0; others sum 0 | 2.61/4.49 | 128.9 |
...
| J-As | 8 | tip | 5 | 4.5097 | 4.2794 | 4.6009 | 0.3216 | 0.0770 | 7.13 % | 1.71 % | 0x32d5e235342b4143 | 0/0/0; others sum 0 | 1.30/4.04 | 124.9 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| J (--cfg default) | 1 | 8.7823 | 7.1062 | -1.6761 | 0.8091 | 0.1909 | 0.0395 | 0.1775 | 9.828 | 0.7231 | 0.8936 |
| J (--cfg default) | 2 | 6.4349 | 4.6586 | -1.7762 | 0.7240 | 0.2760 | 0.0921 | 0.4778 | 5.770 | 0.8074 | 1.1152 |
...
| J-As | 8 | 4.7257 | 4.5097 | -0.2160 | 0.9543 | 0.0457 | 0.0461 | 0.2348 | 6/5 |
...
- dropped slots: [{'slot': ('headline', 1, 0, 'HL-D-allpairs', 'tip', 2), 'attempts': {'original': {'valid': True, 'invalid': [], 'contaminated': True}, 'rerun': {'valid': True, 'invalid': [], 'contaminated': True}}}, {'slot': ('headline', 1, 0, 'HL-D-tree', 'tip', 1), 'attempts': {'original': {'valid': True, 'invalid': [], 'contaminated': True}, 'rerun': {'valid': True, 'invalid': [], 'contaminated': True}}}, {'slot': ('g9', 1, 1, 'J-As', 'tip', 8), 'attempts': {'original': {'valid': True, 'invalid': [], 'contaminated': True}, 'rerun': {'valid': True, 'invalid': [], 'contaminated': True}}}]
