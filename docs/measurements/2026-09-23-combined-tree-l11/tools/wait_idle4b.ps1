# Idle wait for window 4b (P0 idle rule: 0 cargo/rustc/link/miri/test-exe processes on 3 polls 60 s apart, 10-s CPU < 5 %). Adapted from window 3's wait_idle3.ps1 (+miri, cargo-miri, runner_c3, the bench exe name).
