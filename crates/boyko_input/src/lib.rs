...
//!
//! # Scope
//! This is the windowing-independent core (I1–I3 of the design doc). ECS
//! integration (`InputPlugin`, the ingest system, the fixed-step determinism
//! snapshot), `.keys` persistence, runtime rebinding, and the Win32 / egui
//! adapters are added in later rounds (I4–I7); the seams are documented at each
//! module.
...
pub use action::process::process_actions;
