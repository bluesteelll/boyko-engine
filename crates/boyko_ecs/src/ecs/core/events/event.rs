...
///
/// Implementations are generated by `#[derive(Event)]`. Each type gets a
/// unique [`EventId`] assigned on first call to [`event_id`] — see the
/// [`event_registry`] module docs for the startup warm-up contract and
