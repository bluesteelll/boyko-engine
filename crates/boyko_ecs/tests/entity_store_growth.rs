...
#[test]
#[cfg_attr(miri, ignore = "miri-slow: 100k spawns - minutes under Miri; M1/M2 cover the store there")]
...
#[test]
#[cfg_attr(miri, ignore = "miri-slow: 70k spawns; the Miri half is miri_entity_store.rs")]
...
#[test]
#[cfg_attr(miri, ignore = "miri-slow: 50k spawns; the Miri clear/regrow half is miri_entity_store.rs")]
