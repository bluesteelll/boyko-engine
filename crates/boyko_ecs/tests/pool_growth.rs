...
#[test]
#[cfg_attr(miri, ignore = "miri-slow: 100 k rows through the schedule apply-window (see the file's # Miri note)")]
...
#[test]
#[cfg_attr(miri, ignore = "miri-slow: 2500 spawns + 2500 insert migrations through the apply-window (see the file's # Miri note)")]
...
/// depends on it).
#[test]
#[cfg_attr(miri, ignore = "miri-slow: 3000 rows walked whole-slice then by random access (see the file's # Miri note)")]
