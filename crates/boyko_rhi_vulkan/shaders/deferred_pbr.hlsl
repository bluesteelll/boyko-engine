...
static const int   SSAO_BLUR_R              = 5;
static const float SSAO_BLUR_DEPTH_TOL      = 0.1;
static const float SSAO_BLUR_SPATIAL_SIGMA  = 7.0;  // px; radial falloff scale (spans the 11x11)
static const float SSAO_BLUR_DEPTH_SIGMA    = 0.1;  // view_t; depth falloff scale
